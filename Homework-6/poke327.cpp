...
void game_loop()
{
  ...
  while (!world.quit)
  {
    ...
    move_func[static_cast<npc *>(c) != nullptr ? static_cast<npc *>(c)->mtype : move_pc](c, d);
    ...
    c->next_turn += move_cost[static_cast<npc *>(c) != nullptr ? static_cast<npc *>(c)->ctype : char_pc]
